...
const packageConfiguration = {
  entries: [
    ...
    },
    {
      ...
      inputFiles: [
        "node_modules:{node_modules_suffix}/node_modules/@lancedb/**/*",
      ],
    ...
    {
      description:
        "SQLite3 binary libraries for {os} ({arch}) in platform-specific directory",
      inputFiles: [
        "node_modules:{node_modules_suffix}/node_modules/sqlite3/build/Release/node_sqlite3.node",
      ],
  ...
  variables: [
    ...
    },
    {
      ...
      os: "Linux",
      arch: "arm64",
      node_modules_suffix: "linux-arm64",
    ...
    },
    {
      ...
      os: "macOS",
      arch: "arm64",
      node_modules_suffix: "darwin-arm64",
...
function expandPackageConfigurationEntry(entry, variables, target) {
  ...
  for (const variableEntries of relevantVariables) {
    const platformMatches = entry.platforms?.some((platform) =>
